...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/AJTPHProvider"
  ...
  # Or just: s.author    = "alvinjohntandoc"
  # s.authors            = { "alvinjohntandoc" => "alvinjohntandoc@gmail.com" }
  # s.social_media_url   = "http://twitter.com/alvinjohntandoc"
